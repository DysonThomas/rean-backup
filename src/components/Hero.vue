            ...
            <div class="col-md-5">
              <div class="hero-content">
                ...
                <div class="hero-btn mt-5">
                    <button class="btn custom-btn btn-success mr-4">Explore</button>
                    <button class="btn custom-btn btn-outline-success">Products</button>
                </div>
              </div>
            </div>
            <div class="col-md-7">
                <div class="graphic">
                    <img class="banner-img ml-5" src="../assets/Images/2.jpg" alt="">
                </div>
            </div>
          </div>
        </div> 
